...
if (!isset($_COOKIE['Quest17_2'])) {
    setcookie('Quest17_2', false, time() + 2147483647, '', '', '', true);
    setcookie('Timer2', true, time() + 2147483647, '', '', '', true);
}

if (isset($_COOKIE['Quest17_1']) AND isset($_COOKIE['Quest17_2'])) {
    if ($_COOKIE['Quest17_1'] == true AND $_COOKIE['Quest17_2'] == true) {
        if (isset($_SESSION['PageNpc17'])) {
            $_SESSION['PageNpc17']++;
        } else {
            $_SESSION['PageNpc17'] = 1;
        }
    }
}

if (isset($_COOKIE['Quest17_1'])) {
    if ($_COOKIE['Quest17_1'] == true) {
...
$smarty->display("tpl/NPC17.html.tpl");