...
<div class="plaatje">
    ...
    {if isset($smarty.cookies.Quest7_1)}
    {if $smarty.cookies.Quest7_1 == true}
    ...
    {if isset($smarty.cookies.Quest7_2)}
    {if $smarty.cookies.Quest7_2 == true}
        <script type="text/javascript">
            var NpcName = "Lauren";
...
<script type="text/javascript" src="JS/NPC/Npc7.js"></script>
