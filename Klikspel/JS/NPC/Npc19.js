        ...
        buttons: {
            Well_what_for_deal: function() {
                ...
                $('#dialog-2').dialog({
                    ...
                    buttons: {
                        Okey_Sure: function () {
                            $( "#Story" ).replaceWith(Npcname + "<p id='Story'> In exchange i let you through </p>");
                            $('#dialog-2').dialog({
                                autoOpen: true,
                                buttons: {
                                 Okey: function () {
                ...
                $('#dialog-2').dialog({
                    ...
                    buttons: {
                        Well_Should_i_guard_the_door: function () {
                            $( "#Story" ).replaceWith(Npcname + "<p id='Story'> What would you think  </p>");
                            $('#dialog-2').dialog({
                                autoOpen: true,
                                buttons: {
                                    yes: function () {
                                        $( "#Story" ).replaceWith(Npcname + "<p id='Story'>  Of course not </p>");
                                        $('#dialog-2').dialog({
                                            autoOpen: true,
                                            buttons: {
