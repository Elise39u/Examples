            ...
            Why_Are_you_a_guard: function() {
                ...
                buttons: {
                    DO_you_need_help: function () {
                        $( "#Story" ).replaceWith(Npcname + "<p id='Story'> Well we need some weapons <br>" +
                        "In order to defend you wil you seek them </p>");
                        $('#dialog-2').dialog({
                            autoOpen: true,
                            buttons: {
                                Okey_Wich_weapons: function () {
                                    $( "#Story" ).replaceWith(Npcname + "<p id='Story'> Okey the Next Weapons <br>" +
                ...
                $('#dialog-2').dialog({
                    ...
                    buttons: {
                        Yes_Why_not: function () {
                            $( "#Story" ).replaceWith(Npcname + "<p id='Story'> Okey Can you go to the playground <br>" +
