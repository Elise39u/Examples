    ...
    $( "#dialog-2" ).dialog({
        ...
        buttons: {
            Do_you_need_help: function() {
                ...
                buttons: {
                    One: function () {
                        $( "#Story" ).replaceWith(Npcname + "<p id='Story'> Well i am need of something for my work  <br>" +
                    ...
                    two: function () {
                        $( "#Story" ).replaceWith(Npcname + "<p id='Story'> Well can you find a scropion <br>" +
                            " I want to make a picture of that animal</p>");
                        $('#dialog-2').dialog({
                            autoOpen: true,
                            buttons: {
                                Okey_ehh: function () {
                                    $( "#Story" ).replaceWith(Npcname + "<p id='Story'> Okey come back When you know it  </p>");
                                    $('#dialog-2').dialog({
                                        autoOpen: true,
                                        buttons: {
                                            sure: function () {
                                ...
                                You_know_they_are_monsters: function () {
                                    $( "#Story" ).replaceWith(Npcname + "<p id='Story'> Yes Yes Yes know hurry  </p>");
                                    $('#dialog-2').dialog({
                                        autoOpen: true,
                                        buttons: {
            ...
            Why_Pohotgrapher: function () {
                ...
                $('#dialog-2').dialog({
                    ...
                    buttons: {
                        Is_it_fun: function () {
                            $( "#Story" ).replaceWith(Npcname + "<p id='Story'> That depends on you  </p>");
                            $('#dialog-2').dialog({
                                autoOpen: true,
                                buttons: {
