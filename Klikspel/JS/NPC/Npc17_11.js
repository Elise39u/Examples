            ...
            $('#dialog-2').dialog({
                ...
                buttons: {
                    ...
                    Well_what_is_it: function () {
                        $( "#Story" ).replaceWith("<p id='Story'> Well i have a few things to do so can you two wacht the kids <br>" +
                            Npcname1 + " Sure we can do that tell us were they are <br>" +
                            Npcname + " There are on the playyard so i see you two soon <br>" +
                            Npcname1 + " See you soon then </p>");
                        $('#dialog-2').dialog({
                            autoOpen: true,
                            width: 600,
                            buttons: {
            ...
            $('#dialog-2').dialog({
                ...
                buttons: {
                    Okey_Do_i_have_potentials: function () {
                        $( "#Story" ).replaceWith("<p id='Story'> Well ever worked with kids or not <br>" +
                        ...
                        $('#dialog-2').dialog({
                            ...
                            buttons: {
                                yes: function () {
                                    $( "#Story" ).replaceWith("<p id='Story'> So then you could try it </p>");
                                    $('#dialog-2').dialog({
                                        autoOpen: true,
                                        width: 600,
                                        buttons: {
