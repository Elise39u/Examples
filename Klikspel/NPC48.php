...
if (isset($_SESSION['Fred'])) {
    setcookie('Quest48', true, time() + 2147483647, '', '', '', true);
} else {
    setcookie('Quest48', false, time() + 2147483647, '', '', '', true);
}
...
if (isset($_COOKIE['Quest48'])) {
    if ($_COOKIE['Quest48'] == true) {
...
$smarty->display("tpl/NPC48.html.tpl");