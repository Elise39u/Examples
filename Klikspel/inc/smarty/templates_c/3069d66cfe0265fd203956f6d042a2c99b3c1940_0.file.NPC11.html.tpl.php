<?php
/* Smarty version 3.1.29, created on 2017-02-03 08:25:48
  from "C:\wamp64\www\Examplecode\Klikspel\tpl\NPC11.html.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5894307cd295b2_53027647',
  'file_dependency' => 
  array (
    '3069d66cfe0265fd203956f6d042a2c99b3c1940' => 
    array (
      0 => 'C:\\wamp64\\www\\Examplecode\\Klikspel\\tpl\\NPC11.html.tpl',
      1 => 1486035900,
      2 => 'file',
    ),
  ),
...
function content_5894307cd295b2_53027647 ($_smarty_tpl) {
?>
<!DOCTYPE HTML>
<html>
<head>
...
?>
    ...
    <h1> I am Coach Marieke </h1>
    <p id="Bio"></p>
    <p id="NPC"></p>
    <p id="Quest"></p>
    <p id="Quest1"></p>
    <img src="img/Npcs/Npc11.png">
    ...
    <div id = "dialog-2" title = "Dialouge">
        <p id="Story">Marieke: Well what is the problem</p>
    </div>
    <button id = "opener-2"> HI Marieke</button>

    <ul>
        <li><a href="SubYard.php"> Go back </a></li>
    </ul>

    <?php if (isset($_COOKIE['Quest11'])) {?>
    <?php if ($_COOKIE['Quest11'] == true) {?>
        <?php echo '<script'; ?>
 type="text/javascript">
            var NpcName = "Marieke";
            document.getElementById('Quest').innerHTML = NpcName + " Well Go on i dont have all the day";
        <?php echo '</script'; ?>
>
    <?php }?>
    <?php }?>
...
>
<?php echo '<script'; ?>
 type="text/javascript" src="JS/NPC/Npc11.js"><?php echo '</script'; ?>
>
