<?php
/* Smarty version 3.1.29, created on 2017-02-01 14:23:46
  from "C:\wamp64\www\Examplecode\Klikspel\tpl\PrisonBlockD.html.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5891e162270d44_86689747',
  'file_dependency' => 
  array (
    '3ac584d8658892b9c362c569e9d2fe58cd7fda1f' => 
    array (
      0 => 'C:\\wamp64\\www\\Examplecode\\Klikspel\\tpl\\PrisonBlockD.html.tpl',
      1 => 1485955351,
      2 => 'file',
    ),
  ),
...
function content_5891e162270d44_86689747 ($_smarty_tpl) {
?>
<!DOCTYPE HTML>
<html>
<head>
 ...
 type="text/javascript">
        ...
        if (window.name == "Marieke") {
            document.getElementById('Npc11').innerHTML = "Coach Marieke: Well that is creepy <br>" +
                    "But you can better do what he said <?php echo $_SESSION['username'];?>
"
        }

        <?php if (isset($_SESSION['Justin'])) {?>
        var Yep = <?php echo $_SESSION['Justin'];?>
;
        if (Yep == true) {
