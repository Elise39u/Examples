<?php
/* Smarty version 3.1.29, created on 2017-02-02 12:48:04
  from "C:\wamp64\www\Examplecode\Klikspel\tpl\NPC12.html.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_58931c74ee04e9_57785573',
  'file_dependency' => 
  array (
    '708ad41eb5f1ceced0fcb7d2a0721533b7797373' => 
    array (
      0 => 'C:\\wamp64\\www\\Examplecode\\Klikspel\\tpl\\NPC12.html.tpl',
      1 => 1486035975,
      2 => 'file',
    ),
  ),
...
function content_58931c74ee04e9_57785573 ($_smarty_tpl) {
?>
<!DOCTYPE HTML>
<html>
<head>
...
?>
    ...
    <h1> Mother Lieke Here </h1>
    <p id="Bio"></p>
    <p id="NPC"></p>
    <p id="Quest"></p>
    <p id="Quest1"></p>
    <img src="img/Npcs/Npc12.png">
    ...
    <div id = "dialog-2" title = "Dialouge">
        <p id="Story">Lieke: Well what Do you want i am busy</p>
    </div>
    <button id = "opener-2"> Hi lieke </button>
    ...
    <?php if ($_COOKIE['Quest12'] == true) {?>
        <?php echo '<script'; ?>
 type="text/javascript">
            var NpcName = "Lieke";
            document.getElementById('Quest').innerHTML = NpcName + " Thank you very very much";
        <?php echo '</script'; ?>
>
    <?php }?>
    <?php }?>
...
<?php echo '<script'; ?>
 type="text/javascript">
    ...
    if (window.name == 'Marieke') {
        loadScript("JS/NPC/Npc12_11.js", callback)
    }
    else {
        loadScript("JS/NPC/Npc12.js", callback)
    }
    // <?php echo '<script'; ?>
