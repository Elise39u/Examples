<?php
/* Smarty version 3.1.29, created on 2017-01-18 14:28:02
  from "C:\wamp64\www\Examplecode\Klikspel\tpl\NPC34.html.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_587f6d6236e344_86674011',
  'file_dependency' => 
  array (
    'c902d7b5cd185319b87edc635a9331382645370c' => 
    array (
      0 => 'C:\\wamp64\\www\\Examplecode\\Klikspel\\tpl\\NPC34.html.tpl',
      1 => 1484746081,
      2 => 'file',
    ),
  ),
...
function content_587f6d6236e344_86674011 ($_smarty_tpl) {
?>
<!DOCTYPE HTML>
<html>
<head>
...
/<?php echo $_smarty_tpl->tpl_vars['maximumHP']->value;?>
    ...
    <div id = "dialog-2" title = "Dialouge">
        <p id="Story">Teacher Hans: So say it </p>
    </div>
    <button id = "opener-2"> Hi there </button>

    <ul>
        <li><a href="SchoolClass3.php"> Go back  </a></li>
    </ul>
...
?>
    ...
    <?php if (isset($_COOKIE['Quest34'])) {?>
        <?php if ($_COOKIE['Quest34'] == true) {?>
            <?php echo '<script'; ?>
 type="text/javascript">
                var NpcName = "Teacher Hans";
                document.getElementById('Quest').innerHTML = NpcName + " Well thank you very much here is a potion that i found";
            <?php echo '</script'; ?>
>
        <?php }?>
    <?php }?>
...
>
<?php echo '<script'; ?>
 type="text/javascript" src="JS/NPC/Npc34.js"><?php echo '</script'; ?>
>
</html><?php }
}
