<?php
/* Smarty version 3.1.29, created on 2017-01-26 09:37:16
  from "C:\wamp64\www\Examplecode\Klikspel\tpl\ChurchIS.html.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5889b53c9ab2e7_75850434',
  'file_dependency' => 
  array (
    '413318cdbe88aa05c80ec7249ac2df7f56737c34' => 
    array (
      0 => 'C:\\wamp64\\www\\Examplecode\\Klikspel\\tpl\\ChurchIS.html.tpl',
      1 => 1485419613,
      2 => 'file',
    ),
  ),
...
function content_5889b53c9ab2e7_75850434 ($_smarty_tpl) {
?>
<!DOCTYPE HTML>
<html>
<head>
 ...
 type="text/javascript">
        if (window.name == "Marieke") {
            document.getElementById('Npc11').innerHTML = "Coach Marieke: perhaps you have to got look somewhere else <br>" +
                    "Or should we go back <?php echo $_SESSION['username'];?>
 <br>" +
                    "<?php echo $_SESSION['username'];?>
: Well that not and i go look somewhere else <br>" +
