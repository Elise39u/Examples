<?php
/* Smarty version 3.1.29, created on 2017-01-17 15:29:23
  from "C:\wamp64\www\Examplecode\Klikspel\tpl\NPC14.html.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_587e2a43352af2_93804911',
  'file_dependency' => 
  array (
    '0df727d38d3fc0a086a213e920b5e1e1432aa236' => 
    array (
      0 => 'C:\\wamp64\\www\\Examplecode\\Klikspel\\tpl\\NPC14.html.tpl',
      1 => 1484663361,
      2 => 'file',
    ),
  ),
...
function content_587e2a43352af2_93804911 ($_smarty_tpl) {
?>
<!DOCTYPE HTML>
<html>
<head>
...
/<?php echo $_smarty_tpl->tpl_vars['maximumHP']->value;?>
    ...
    <div id = "dialog-2" title = "Dialouge">
        <p id="Story">Monsternon: What is there</p>
    </div>
    <button id = "opener-2"> Hi Monsternon  </button>
    ...
    <?php if ($_COOKIE['Quest14'] == true) {?>
        <?php echo '<script'; ?>
 type="text/javascript">
            var NpcName = "Monsternon";
            document.getElementById('Quest').innerHTML = NpcName + " Well thnaxs and i am alco indeed";
        <?php echo '</script'; ?>
>
    <?php }?>
    <?php }?>
...
>
<?php echo '<script'; ?>
 type="text/javascript" src="JS/NPC/Npc14.js"><?php echo '</script'; ?>
>
</html><?php }
}
