<?php
/* Smarty version 3.1.29, created on 2017-01-27 10:13:46
  from "C:\wamp64\www\Examplecode\Klikspel\tpl\NPC25.html.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_588b0f4af23581_61288722',
  'file_dependency' => 
  array (
    'd084f21cdacb410d020dc564070c0ba29e04d334' => 
    array (
      0 => 'C:\\wamp64\\www\\Examplecode\\Klikspel\\tpl\\NPC25.html.tpl',
      1 => 1485172644,
      2 => 'file',
    ),
  ),
...
function content_588b0f4af23581_61288722 ($_smarty_tpl) {
?>
<!DOCTYPE HTML>
<html>
<head>
...
?>
    ...
    <h1> Well i am Hans </h1>
    <p id="Bio"></p>
    <p id="NPC"></p>
    <p id="Quest"></p>
    <p id="Quest1"></p>
    <img src="img/Npcs/Npc25.png">
    <!--
    ...
    <div id = "dialog-2" title = "Dialouge">
        <p id="Story">Hans: So what is the problem </p>
    </div>
    <button id = "opener-2"> Hi there </button>

    <ul>
        <li><a href="HotelD.php"> Go back  </a></li>
    </ul>
...
?>
    ...
    <?php if (isset($_COOKIE['Quest25'])) {?>
        <?php if ($_COOKIE['Quest25'] == true) {?>
            <?php echo '<script'; ?>
 type="text/javascript">
                var NpcName = "Hans";
                document.getElementById('Quest').innerHTML = NpcName + " Well thanks now i need to make dinner for the guest around here <br>" +
                        "So if you excuse me";
            <?php echo '</script'; ?>
>
        <?php }?>
...
>
<?php echo '<script'; ?>
 type="text/javascript" src="JS/NPC/Npc25.js"><?php echo '</script'; ?>
>
</html><?php }
}
