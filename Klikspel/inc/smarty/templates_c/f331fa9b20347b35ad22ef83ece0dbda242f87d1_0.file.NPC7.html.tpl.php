<?php
/* Smarty version 3.1.29, created on 2017-02-02 12:47:46
  from "C:\wamp64\www\Examplecode\Klikspel\tpl\NPC7.html.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_58931c623116d7_66892333',
  'file_dependency' => 
  array (
    'f331fa9b20347b35ad22ef83ece0dbda242f87d1' => 
    array (
      0 => 'C:\\wamp64\\www\\Examplecode\\Klikspel\\tpl\\NPC7.html.tpl',
      1 => 1486035869,
      2 => 'file',
    ),
  ),
...
function content_58931c623116d7_66892333 ($_smarty_tpl) {
?>
<!DOCTYPE HTML>
<html>
<head>
...
?>
    ...
    <h1> Lauren Beauty Here </h1>
    <p id="Bio"></p>
    <p id="NPC"></p>
    <p id="Quest"></p>
    <p id="Quest1"></p>
    <img src="img/Npcs/Npc7.png">
    ...
    <div id = "dialog-2" title = "Dialouge">
        <p id="Story">Lauren: Well hi there what do you want</p>
    </div>
    <button id = "opener-2"> HI there Lauren</button>

    <ul>
        <li><a href="SubYard.php"> Go back </a></li>
    </ul>

    <?php if (isset($_COOKIE['Quest7_1'])) {?>
    <?php if ($_COOKIE['Quest7_1'] == true) {?>
        <?php echo '<script'; ?>
 type="text/javascript">
            var NpcName = "Lauren";
            document.getElementById('Quest').innerHTML = NpcName + " Well Thank you and Sweetie";
        <?php echo '</script'; ?>
>
    <?php }?>
    <?php }?>

    <?php if (isset($_COOKIE['Quest7_2'])) {?>
    <?php if ($_COOKIE['Quest7_2'] == true) {?>
        <?php echo '<script'; ?>
 type="text/javascript">
            var NpcName = "Lauren";
            document.getElementById('Quest1').innerHTML = NpcName + " Well Thanks for the camera";
        <?php echo '</script'; ?>
>
    <?php }?>
    <?php }?>
...
>
<?php echo '<script'; ?>
 type="text/javascript" src="JS/NPC/Npc7.js"><?php echo '</script'; ?>
>
