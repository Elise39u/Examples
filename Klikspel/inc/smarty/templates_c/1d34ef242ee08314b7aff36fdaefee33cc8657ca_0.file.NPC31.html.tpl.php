<?php
/* Smarty version 3.1.29, created on 2017-01-24 11:59:35
  from "C:\wamp64\www\Examplecode\Klikspel\tpl\NPC31.html.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5887339764ee95_82202962',
  'file_dependency' => 
  array (
    '1d34ef242ee08314b7aff36fdaefee33cc8657ca' => 
    array (
      0 => 'C:\\wamp64\\www\\Examplecode\\Klikspel\\tpl\\NPC31.html.tpl',
      1 => 1485172673,
      2 => 'file',
    ),
  ),
...
function content_5887339764ee95_82202962 ($_smarty_tpl) {
?>
<!DOCTYPE HTML>
<html>
<head>
...
?>
    ...
    <h1> Well i am Christina </h1>
    <p id="Bio"></p>
    <p id="NPC"></p>
    <p id="Quest"></p>
    <p id="Quest1"></p>
    <img src="img/Npcs/Npc31.png">
    <!--
    ...
    <div id = "dialog-2" title = "Dialouge">
        <p id="Story">Christina: So what is the problem </p>
    </div>
...
?>
    ...
    <?php if (isset($_COOKIE['Quest31'])) {?>
        <?php if ($_COOKIE['Quest31'] == true) {?>
            <?php echo '<script'; ?>
 type="text/javascript">
                var NpcName = "Christina";
                document.getElementById('Quest').innerHTML = NpcName + " Well thank you here are some weapons";
            <?php echo '</script'; ?>
>
        <?php }?>
    <?php }?>
...
>
<?php echo '<script'; ?>
 type="text/javascript" src="JS/NPC/Npc31.js"><?php echo '</script'; ?>
>
</html><?php }
}
