...
$_SESSION['Ask'] = true;
if (isset($_SESSION['Helped'])) {
    setcookie('Quest53', true, time() + 2147483647, '', '', '', true);
}
if (isset($_SESSION['FreeKichten'])) {
    setcookie('Quest53_1', true, time() + 2147483647, '', '', '', true);
    unset($_SESSION['Helped']);
    $_SESSION['BlockD'] = true;
}
/*
...
$smarty->display("tpl/NPC53.html.tpl");